...
const simulateLaps = async (req, res) => {
    ...
    const { trackType, baseLapTime } = track;
    ...
    for (const entrant of entrants) {
        try {
            ...
            const lapResponse = await axios.post(getLapURL, { trackType, baseLapTime }, { httpsAgent });
            ...
            return res.status(500).json({ code: 500, result: """ });
        }
    }
