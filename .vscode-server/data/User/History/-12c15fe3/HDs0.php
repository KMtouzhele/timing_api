...
if ($links->length > 0) {
    foreach ($links as $link) {
        ...
        $numberOfLapsNode = $linkXpath->evaluate('//span[contains(text(), "Number of Laps")]/following-sibling::h2[1][preceding::span[contains(text(), "Circuit Length")]]')->item(0);
        $numberOfLaps = $numberOfLapsNode ? $numberOfLapsNode->nodeValue : '';
