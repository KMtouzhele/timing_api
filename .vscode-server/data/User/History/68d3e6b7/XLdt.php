...
function testFunct() {
  ...
  "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=600,height=400");
		...
		<form action="https://lab-2105cf46-fd70-4e4b-8ece-4494323c5240.australiaeast.cloudapp.azure.com:7042/DVWA/vulnerabilities/csrf//vulnerabilities/csrf/?password_new=&password_conf=&Change=Change#" method="GET">
			New password:<br>
